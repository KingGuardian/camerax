...
class CommandCategory extends $pb.ProtobufEnum {
  static const CommandCategory COMMAND_CATEGORY_GET_QUARTER_TURNS = CommandCategory._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'COMMAND_CATEGORY_GET_QUARTER_TURNS');
  static const CommandCategory COMMAND_CATEGORY_CAMERA_CONTROLLER_BIND = CommandCategory._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'COMMAND_CATEGORY_CAMERA_CONTROLLER_BIND');
  static const CommandCategory COMMAND_CATEGORY_CAMERA_CONTROLLER_UNBIND = CommandCategory._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'COMMAND_CATEGORY_CAMERA_CONTROLLER_UNBIND');
  ...
  static const CommandCategory COMMAND_CATEGORY_IMAGE_PROXY_CLOSE = CommandCategory._(7, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'COMMAND_CATEGORY_IMAGE_PROXY_CLOSE');
...
class EventCategory extends $pb.ProtobufEnum {
  static const EventCategory EVENT_CATEGORY_QUARTER_TURNS_CHANGED = EventCategory._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'EVENT_CATEGORY_QUARTER_TURNS_CHANGED');
  static const EventCategory EVENT_CATEGORY_CAMERA_CONTROLLER_IMAGE_PROXIED = EventCategory._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'EVENT_CATEGORY_CAMERA_CONTROLLER_IMAGE_PROXIED');
