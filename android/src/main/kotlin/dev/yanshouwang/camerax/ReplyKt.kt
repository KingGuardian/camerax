...
public inline fun reply(block: dev.yanshouwang.camerax.ReplyKt.Dsl.() -> kotlin.Unit): dev.yanshouwang.camerax.Messages.Reply =
  dev.yanshouwang.camerax.ReplyKt.Dsl._create(dev.yanshouwang.camerax.Messages.Reply.newBuilder()).apply { block() }._build()
public object ReplyKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: dev.yanshouwang.camerax.Messages.Reply.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: dev.yanshouwang.camerax.Messages.Reply.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): dev.yanshouwang.camerax.Messages.Reply = _builder.build()

    /**
     * <code>.messages.GetQuarterTurnsReplyArguments get_quarter_turns_arguments = 1;</code>
     */
    public var getQuarterTurnsArguments: dev.yanshouwang.camerax.Messages.GetQuarterTurnsReplyArguments
     ...
     */
    public var cameraControllerBindArguments: dev.yanshouwang.camerax.Messages.CameraControllerBindReplyArguments
    ...
    public val argumentsCase: dev.yanshouwang.camerax.Messages.Reply.ArgumentsCase
...
@kotlin.jvm.JvmSynthetic
public inline fun dev.yanshouwang.camerax.Messages.Reply.copy(block: dev.yanshouwang.camerax.ReplyKt.Dsl.() -> kotlin.Unit): dev.yanshouwang.camerax.Messages.Reply =
  dev.yanshouwang.camerax.ReplyKt.Dsl._create(this.toBuilder()).apply { block() }._build()
